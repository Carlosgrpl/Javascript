...
console.log(
  numArray[0]
); /* 10 */ /* Accedemos a un elemento del array, dentro del indice, poniendo [0] nos dará el primer elemento, si pongo [3] nos dará el cuarto... osea sería 40 */

const Countries = ["Spain", "Mexico", "Ecuador"];
...
const numbers = [1383838183823, 9394, 9489384, 0];
console.log(numbers);
numbers.sort();
console.log(numbers);
...
const allNumber = numArray.concat(numbers);
...
/* Separa cada palabra del string en un array, por indice... */ /* el salto de línea se hac econ "\n" */
/* Muy útil si por ejemplo queremos dividir los datos por saltos de línea ("\n") */
let lorem =
  "Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit, deserunt!";
...
console.log(numArray.includes(393939)); /* False */
console.log(numArray.includes(50)); /* True */
/* Nos dice true o false si el array incluye el número o no, funciona con strings también, pero no con objetos */
console.log(Countries.includes("Ecuador")); /* True */
