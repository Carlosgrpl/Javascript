...
console.log("Hello World"); //alert("stawp");
...
var userName = "Carlos";
/* aqui creamos la variable, info de tipo STRING */

var userAge = 25;
/* aqui creamos la variable, info de tipo NUMBER */

var isOnline = true;
/* aqui creamos la variable, info de tipo BOOLEAN */
...
var expResult = Math.pow(NUM1, NUM2);
/* No se usa practicamente */

console.log("expResult: ", expResult);
/* utilizar la propia variable para modificar su valor */

var numerito1 = 1;
numerito1 = 20;
/* o puedo hacer esto */

numerito1 = numerito1 + 9999;
console.log("numerito1: ", numerito1);
/* o puedo hacer*/

numerito1++;
/* Autoincremento. Sumale uno más al valor de number, eso significa el ++*/
...
var fullName = "Carlos ".concat(myLastName);

var _myCompleteName = "".concat(myLastName, " ").concat(myName);
